! function (e, t) {
    "object" === typeof exports && "object" === typeof module ? module.exports = t() : "function" === typeof define && define.amd ? define([], t) : "object" === typeof exports ? exports.Tree = t() : e.Tree = t()
}(window, function () {
    return function (e) {
        var t = {};
        ...
        n(2), d.prototype.init = function (e) {
            var t = d.parseTreeData(e),
                ...
                s = t.defaultValues,
                i = t.defaultDisables;
            this.treeNodes = n, this.nodesById = r, this.leafNodesById = o, this.render(this.treeNodes);
            var a = this.options,
                l = a.values,
                c = a.disables,
                u = a.loaded;
            l && l.length && (s = l), s.length && this.setValues(s), c && c.length && (i = c), i.length && this.setDisables(i), u && u.call(this)
            ...
            return e && e.length && e.forEach(function (e) {
                ...
                var s = null;
                e.children && e.children.length && (s = n.buildTree(e.children, t + 1)), s && o.appendChild(s), r.appendChild(o)
            }), r
        }, d.prototype.bindEvent = function (e) {
            var t = this;
            e.addEventListener("click", function (e) {
                var n = e.target;
                "SPAN" === n.nodeName && (n.classList.contains("treejs-checkbox") || n.classList.contains("treejs-label")) ? t.onItemClick(n.parentNode.nodeId) : "LI" === n.nodeName && n.classList.contains("treejs-node") ? t.onItemClick(n.nodeId) : "SPAN" === n.nodeName && n.classList.contains("treejs-switcher") && t.onSwitcherClick(n)
            }, !1)
        }, d.prototype.onItemClick = function (e) {
            var t = this.nodesById[e],
                n = this.options.onChange;
            //MODIFICACIÓN PARA QUE SOLO PERMITA UN CHECKBOXX ACTIVO
            if(this.options.type==="only"){
                this.setValues([]);
        ...
        d.prototype.setValues = function (e) {
            ...
            if (n) {
                if ("status" === t) {
                    ...
                    if (r = o ? o === 2 * n.children.length ? 2 : 1 : 0, n.status === r) return;
                    n.status = r
                } else {
            ...
            return function e(t, n) {
                t.forEach(function (t) {
                    r[t.id] = t, t.checked && s.push(t.id), t.disabled && i.push(t.id), n && (t.parent = n), t.children && t.children.length ? e(t.children, t) : o[t.id] = t
                })
            }(n), {
                treeNodes: n,
                nodesById: r,
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            var t = {
                ...
                o = Object.entries(n.data).reduce(function (e, t) {
            ...
            if ("POST" === n.method.toUpperCase()) r.open(n.method, n.url, n.async), r.setRequestHeader("Content-Type", n["Content-Type"]), r.send(o);
            else if ("GET" === n.method.toUpperCase()) {
                var s = n.url;
                o && (s.indexOf("?"), s += "&".concat(o)), r.open(n.method, s, n.async), r.setRequestHeader("Content-Type", n["Content-Type"]), r.send(null)
            }
        ...
        function m(e, t) {
            ...
            if (t.singleton) {
                var i = l++;
                n = d || (d = y(t)), r = w.bind(null, n, i, !1), o = w.bind(null, n, i, !0)
        ...
        e.exports = function (e) {
            ...
            return e.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function (e, t) {
                var o, s = t.trim().replace(/^"(.*)"$/, function (e, t) {
                    return t
                }).replace(/^'(.*)'$/, function (e, t) {
                    return t
                });
                return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(s) ? e : (o = 0 === s.indexOf("//") ? s : 0 === s.indexOf("/") ? n + s : r + s.replace(/^\.\//, ""), "url(" + JSON.stringify(o) + ")")
            })
        }
    }]).default
});
