...
<button class="sub-btn" type="button" id="removeRoutes">
    ...
    function panelSlider() {
        ...
        function mobiledrag(){
            ...
            // block.style.height = block.offsetHeight + e.clientY - e.originalEvent.touches[0].clientX + "px";
            console.log("suma:"); console.log(window.innerHeight - e.originalEvent.touches[0].clientX)
                                block.style.height = window.innerHeight - e.originalEvent.touches[0].clientX + "px";
                           
                     // moved down
                 }else if(currentY < lastY){
                   console.log("move up")  // moved up
            console.log("__________");
            // block.style.height = block.offsetHeight + e.clientY - e.originalEvent.touches[0].clientX + "px";
            console.log("resta:"); console.log(window.innerHeight - e.originalEvent.touches[0].clientX)
                                block2.style.height = window.innerHeight - e.originalEvent.touches[0].clientX + "px";
                  console.log("__________");         
                     // moved down
                 }
                 lastY = currentY;
